...
\begin{center}
    ...
    %\legend{Lineal}
    \draw [red] ({rel axis cs:0,0}|-{axis cs:10,4.98}) -- ({rel axis cs:1,0}|-{axis cs:10,4.98}) node [pos=0.33, above] {Entropia};
    \end{axis}
    \end{tikzpicture}
\end{center}
...
\begin{center}
    ...
    %\addplot[color=blue] table[x index=0,y index=1]{datos/timesplines};
    %\legend{Lineal}
    \draw [red] ({rel axis cs:0,0}|-{axis cs:10,6.19}) -- ({rel axis cs:1,0}|-{axis cs:10,6.19}) node [pos=0.33, above] {Entropia};
    \end{axis}
    \end{tikzpicture}
\end{center}
...
\begin{center}
    ...
    %\addplot[color=blue] table[x index=0,y index=1]{datos/timesplines};
    %\legend{Lineal}
    \draw [red] ({rel axis cs:0,0}|-{axis cs:10,5.91}) -- ({rel axis cs:1,0}|-{axis cs:10,5.91}) node [pos=0.33, above] {Entropia};
    \end{axis}
    \end{tikzpicture}
\end{center}
...
\begin{center}
    ...
    %\addplot[color=blue] table[x index=0,y index=1]{datos/timesplines};
    %\legend{Lineal}
    \draw [red] ({rel axis cs:0,0}|-{axis cs:10,3.51}) -- ({rel axis cs:1,0}|-{axis cs:10,3.51}) node [pos=0.33, above] {Entropia};
    \end{axis}
    \end{tikzpicture}
\end{center}
